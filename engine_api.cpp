...
void MessageBegin(int msg_dest, int msg_type, const float *pOrigin, edict_t *ed) 
{
	...
	BEGIN_MESSAGE_HOOK(msg_dest, msg_type, ed);
...
C_DLLEXPORT int GetEngineFunctions_Post(enginefuncs_t *pengfuncsFromEngine, int *interfaceVersion ) {
	UTIL_LogPrintf("Registering Post Functions");
	meta_engfuncs_post.pfnMessageBegin = MessageBegin;
	meta_engfuncs_post.pfnMessageEnd = MessageEnd;
	meta_engfuncs_post.pfnWriteByte = WriteByte;
	meta_engfuncs_post.pfnWriteChar = WriteChar;
	meta_engfuncs_post.pfnWriteShort = WriteShort;
	meta_engfuncs_post.pfnWriteLong = WriteLong;
	meta_engfuncs_post.pfnWriteAngle = WriteAngle;
	meta_engfuncs_post.pfnWriteCoord = WriteCoord;
	meta_engfuncs_post.pfnWriteString = WriteString;
	meta_engfuncs_post.pfnWriteEntity =  WriteEntity;
